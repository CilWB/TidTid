...
KEEP extern const touchgfx::KerningNode kerning_segoeuib_18_4bpp[] FONT_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    {0x0072,  1},  // (First char = [0x0072, ], Second char = [0x0076, ], Kerning dist = 1) 
    ...
    {0x0072,  1},  // (First char = [0x0072, ], Second char = [0x0079, ], Kerning dist = 1) 
};
